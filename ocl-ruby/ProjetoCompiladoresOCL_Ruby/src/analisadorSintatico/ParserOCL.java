...
// Sat Jun 04 14:52:37 GMT-03:00 2011
//----------------------------------------------------
...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sat Jun 04 14:52:37 GMT-03:00 2011
  */
 ...
 parser.as.opCollection = true; 
		...
		Object pn = (Object)((java_cup.runtime.Symbol) CUP$ParserOCL$stack.peek()).value;
		 Node node = new Node(((Node)pn).getValue(), "");
								 String code = (String)((Node)pn).getValue();
								 node.setCode(code);
		...
		Object pn = (Object)((java_cup.runtime.Symbol) CUP$ParserOCL$stack.elementAt(CUP$ParserOCL$top-1)).value;
		 parser.as.checkStereotype("@pre", pnleft);
										  Node node = new Node(((Node)pn).getValue(), "");
								 		  node.setRole(Node.VARIABLE);
								 		  node.setCode(((Node)pn).toString()+"_pre");
		...
		Object params1 = (Object)((java_cup.runtime.Symbol) CUP$ParserOCL$stack.peek()).value;
		  Node node = new Node(((Node)pn).getValue(), "");
								 		  			 ...
								 		  			 String code = ((Node)pn).getValue() + ((Node)params1).getCode();
								 					 node.setCode(code);
								 		  			 RESULT = node;
 ...
 parser.as.checkStereotype("@pre", pnleft); 
		...
		Object r = (Object)((java_cup.runtime.Symbol) CUP$ParserOCL$stack.peek()).value;
		 parser.as.checkStereotype("result", rleft); 
				   			     ...
				   			     node.setRole(Node.VARIABLE);
				   			     node.setCode("@result" + Util.capitalizeFirst(parser.as.getContextMethod()));
				   			     RESULT = node;
		...
		Object pfea1 = (Object)((java_cup.runtime.Symbol) CUP$ParserOCL$stack.peek()).value;
		 Node node = (Node)pfea1;
																						...
																						node.setCode("->" + ((Node)fCol1).getCode() + ((Node)pfea1).getCode());
																						RESULT = node; 
 ...
 Node fCall = (Node)fCall1;
		...
		Object pfea1 = (Object)((java_cup.runtime.Symbol) CUP$ParserOCL$stack.peek()).value;
		 Node node;
                                                                          if (((Node)pfea1).getElements().size() == 0){
                                                                          	...
                                                                          	node = aux;
                                                                          	node.setCode(CollectionOpGenerator.getCode(((Node)pe1).getCode() + ((Node)pfea1).getCode()));
                                                                          }
                                                                          RESULT = node; 
              CUP$ParserOCL$result = parser.getSymbolFactory().newSymbol("postfixExpression",19, ((java_cup.runtime.Symbol)CUP$ParserOCL$stack.elementAt(CUP$ParserOCL$top-1)), ((java_cup.runtime.Symbol)CUP$ParserOCL$stack.peek()), RESULT);
            }
		...
		Object fpla1 = (Object)((java_cup.runtime.Symbol) CUP$ParserOCL$stack.peek()).value;
		 Node node = (Node)fpla1;
																					...
																					node.setCode(((Node)fp1).getCode() + ((Node)fpla1).getCode());
																					RESULT = node;
		...
		Object ct1 = (Object)((java_cup.runtime.Symbol) CUP$ParserOCL$stack.elementAt(CUP$ParserOCL$top-2)).value;
		 parser.as.setContext(((Node)ct1).toString(), new Node(), ct1left);
					 									   CodeGenerator.getInstance().addContextMethodCall(((Node)ct1).getOperation(),((Node)ct1).getOperation()
					 									   + "()");
					 									   RESULT = ct1; 
		...
		Object exp1 = (Object)((java_cup.runtime.Symbol) CUP$ParserOCL$stack.peek()).value;
		 Node node = new Node();
															  if (((String)s1).equals("Pre")){
																String name = CodeGenerator.getInstance().addPre(parser.as.getContextMethod());
																node.setCode("\n\tdef " + name + "()\n" + ((Node)exp1).getCode() + "\n\tend\n");
															  }
															  else{
															    String name = CodeGenerator.getInstance().addPost(parser.as.getContextMethod());
															    node.setCode("\n\tdef " + name + "()\n" + ((Node)exp1).getCode() + "\n\tend\n");
															  }
		...
		Object exp1 = (Object)((java_cup.runtime.Symbol) CUP$ParserOCL$stack.peek()).value;
		 Node node = new Node();
																 if (((String)s1).equals("Pre")){
																 	String name = "checkPre" + ((String)id) + Util.capitalizeFirst(parser.as.getContextMethod());
																	CodeGenerator.getInstance().addPre(parser.as.getContextMethod(), name);
																	node.setCode("\n\tdef " + name + "()\n" + ((Node)exp1).getCode() + "\n\tend\n");
																 }
																 else{
																 	String name = "checkPost" + ((String)id) + Util.capitalizeFirst(parser.as.getContextMethod());
																 	CodeGenerator.getInstance().addPost(parser.as.getContextMethod(), name);
																 	node.setCode("\n\tdef " + name + "()\n" + ((Node)exp1).getCode() + "\n\tend\n");
															     }
		...
		Object ca1 = (Object)((java_cup.runtime.Symbol) CUP$ParserOCL$stack.peek()).value;
								...
								String code = ((Node)cd1).getCode() + ((Node)cb1).getCode() + ((Node)ca1).getCode() + CodeGenerator.getInstance().getAllPre()
								 + CodeGenerator.getInstance().getAllPost();
								CodeGenerator.getInstance().writeToFile(code + CodeGenerator.getInstance().getMain() + "\nend");
								CodeGenerator.getInstance().setClassCode(parser.as.getContextClass(),(code + "\nend"));
