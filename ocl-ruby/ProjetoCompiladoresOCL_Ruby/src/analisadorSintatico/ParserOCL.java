...
// Wed May 04 00:37:41 GMT-03:00 2011
//----------------------------------------------------
...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Wed May 04 00:37:41 GMT-03:00 2011
  */
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$ParserOCL$act_num)
		...
		Object tn = (Object)((java_cup.runtime.Symbol) CUP$ParserOCL$stack.elementAt(CUP$ParserOCL$top-1)).value;
		 //TODO: fazer parte de collection
 ...
 parser.as.checkStereotype("@pre", pnleft); 
		...
		Object fCall1 = (Object)((java_cup.runtime.Symbol) CUP$ParserOCL$stack.peek()).value;
		 System.out.println("Entrou primExp como featureCall");
				   						   ...
				   						   Node node = parser.as.checkFeatureCall(parser.as.getContextClass(),fCall, fCall.getRole(), fCall1left);
				   						   System.out.println("Tipo do atributo: " + node.getType());
				   						   RESULT = node;
				   						     Iterator<Node> it = ((Node)RESULT).iterator();
				                                  while(it.hasNext()){
				                                     System.out.println("Params: " + it.next().getValue());
				                                  }; 
              CUP$ParserOCL$result = parser.getSymbolFactory().newSymbol("primaryExpression",22, ((java_cup.runtime.Symbol)CUP$ParserOCL$stack.peek()), ((java_cup.runtime.Symbol)CUP$ParserOCL$stack.peek()), RESULT);
            }
          return CUP$ParserOCL$result;
		...
		Object rea = (Object)((java_cup.runtime.Symbol) CUP$ParserOCL$stack.peek()).value;
		 Node node = new Node(); 
                                                                                     		 	      	 ...
                                                                                     		 	      	 node.setValue(parser.as.calcRelationalValue((Node)ae2, (Node)rea, (String)((Node)rea).getOperation(), type));
                                                                                     		 	      	 node.setType("Boolean");
                                                                                     		 	      	 node.setOperation((String)ro1);
                                                                          			 		 	   		 RESULT = node; 
		...
		Object rea = (Object)((java_cup.runtime.Symbol) CUP$ParserOCL$stack.peek()).value;
		 System.out.println("Entrou relational exp");
																			   ...
																			   if (rea == null)
                                                                                  ...
                                                                                  node.setValue(parser.as.calcRelationalValue((Node)ae1, (Node)rea, (String)((Node)rea).getOperation(), type));
                                                                                  node.setType("Boolean");
                                                                          	   }
                                                                          	   System.out.println("Relational   ... valorrr...   " + ((Node)node).getValue());
                                                                          	   RESULT = node;
		...
		Object lea1 = (Object)((java_cup.runtime.Symbol) CUP$ParserOCL$stack.peek()).value;
		 Node node = new Node(); 
                                                                                     		 	   ...
                                                                                     		 	   if (lea1 == null){
                                                                                        	 	      ...
                                                                                        	 	      node.setType(type);
                                                                                        	 	      node.setValue(((Node)re1).getValue());
                                                                                        	       } else{
                                                                                     		 	      type = parser.as.maxType(((Node)re1).getType(), ((Node)lea1).getType(), re1left);
                                                                                     		 	      if ((type == null) || !type.equals("Boolean")){
                                                                                     		 		     type = "Boolean";
                                                                                     		 		     node.setValue(new Boolean(false));
                                                                                     		 		  }
                                                                                     		 		  else
                                                                                     		 		     node.setValue(parser.as.calcLogicalValue((Boolean)((Node)re1).getValue(), (Boolean)((Node)lea1).getValue(), (String)((Node)lea1).getOperation()));
                                                                              				 		  node.setType(type);
                                                                          			 		 	   }
		...
		Object lea1 = (Object)((java_cup.runtime.Symbol) CUP$ParserOCL$stack.peek()).value;
		 System.out.println("Entrou logical exp"); Node node = new Node(); 
                                                                            if (lea1 == null)
                                                                          	...
                                                                          	RESULT = node;
                                                                          	System.out.println("Logical   ... valorrr...   " + ((Node)node).getValue());
		...
		Object ct1 = (Object)((java_cup.runtime.Symbol) CUP$ParserOCL$stack.elementAt(CUP$ParserOCL$top-2)).value;
		 parser.as.setContext(((Node)ct1).toString()); 
		...
		Object ocltype1 = (Object)((java_cup.runtime.Symbol) CUP$ParserOCL$stack.peek()).value;
		 parser.as.setContext(((Node)ct1).toString());
					 															   if (!parser.as.getContextType().equals(((Node)ocltype1).toString()))
					 															       throw new excecoes.SemanticErrorException("tipo especificado no contexto diferente do tipo da operacao na linha " 
					 																	+ (ocltype1left+1) + ".\n" + ((Node)ocltype1).toString() + " deve ser substituido por " + parser.as.getContextType()); 
		...
		Object ct2 = (Object)((java_cup.runtime.Symbol) CUP$ParserOCL$stack.peek()).value;
		 parser.as.setContext(((Node)ct1).toString());
					 																 if (!parser.as.getContextType().equals(((Node)ct2).toString()))
					 																 	throw new excecoes.SemanticErrorException("tipo especificado no contexto diferente do tipo da operacao na linha " 
					 																 	+ (ct2left+1) + ".\n" + ((Node)ct2).toString() + " deve ser substituido por " + parser.as.getContextType()); 
              CUP$ParserOCL$result = parser.getSymbolFactory().newSymbol("operationContext",7, ((java_cup.runtime.Symbol)CUP$ParserOCL$stack.elementAt(CUP$ParserOCL$top-4)), ((java_cup.runtime.Symbol)CUP$ParserOCL$stack.peek()), RESULT);
            }
          return CUP$ParserOCL$result;
