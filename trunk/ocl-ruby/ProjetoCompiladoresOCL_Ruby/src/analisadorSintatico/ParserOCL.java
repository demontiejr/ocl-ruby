...
// Sat Apr 30 18:55:43 GMT-03:00 2011
//----------------------------------------------------
...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sat Apr 30 18:55:43 GMT-03:00 2011
  */
...
class CUP$ParserOCL$actions {
 ...
 parser.as.checkStereotype("@pre", pnleft); 
		...
		Object pfea1 = (Object)((java_cup.runtime.Symbol) CUP$ParserOCL$stack.peek()).value;
		 Node node = new Node();
                                                                          if (pfea1 == null){
                                                                          	node.setValue(((Node)pe1).getValue());
                                                                            node.setType(((Node)pe1).getType());
                                                                          }
                                                                          else{
                                                                          	node.setValue(((Node)pfea1).getValue());
		...
		Object mea1 = (Object)((java_cup.runtime.Symbol) CUP$ParserOCL$stack.peek()).value;
		 Node node = new Node();
                                                                                     		 String type;
                                                                                     		 if (mea1 == null){
                                                                                     		 	type = ((Node)ue1).getType();
                                                                                     		 	if (!(type.equals("Float") || type.equals("Integer"))){
                                                                                     		 		parser.as.error(ue1left, "operador ' / ' indefinido para o tipo " + type);
                                                                                     		 		type = "Integer";
                                                                                        	 	}
                                                                                        	 	...
                                                                                        	 	node.setType(type);
                                                                                     		 	...
                                                                                     		 	type = parser.as.maxType(((Node)ue1).getType(), ((Node)mea1).getType(), ue1left);
                                                                                     		 	if (type == null)
                                                                                     		 		type = ((Node)mea1).getType();
                                                                              				 	node.setType(type);
                                                                          			 		 }
                                                                          			 		 RESULT = node; 
		...
		Object mea1 = (Object)((java_cup.runtime.Symbol) CUP$ParserOCL$stack.peek()).value;
		 System.out.println("Entrou mult exp"); Node node = new Node(); 
                                                                                     if (mea1 == null)
                                                                                     	...
                                                                                     	String type = parser.as.maxType(((Node)ue1).getType(), ((Node)mea1).getType(), ue1left);
                                                                                     	if (type == null)
                                                                                     		type = ((Node)mea1).getType();
                                                                              			node.setType(type);
                                                                          			 }
		...
		Object aea1 = (Object)((java_cup.runtime.Symbol) CUP$ParserOCL$stack.peek()).value;
		 Node node = new Node(); 
                                                                                     		 	   String type;
                                                                                     		 	   if (aea1 == null){
                                                                                     		 	   	  type = ((Node)me1).getType();
                                                                                     		 	   if (!(type.equals("Float") || type.equals("Integer"))){
                                                                                     		 		  parser.as.error(me1left, "operador ' - ' indefinido para o tipo " + type);
                                                                                     		 		  type = "Integer";
                                                                                        	 	   }
                                                                                        	 		  node.setType(type);
                                                                                        	 	   } else{
                                                                                     		 	      type = parser.as.maxType(((Node)me1).getType(), ((Node)aea1).getType(), me1left);
                                                                                     		 	      if (type == null)
                                                                                     		 		     type = ((Node)aea1).getType();
                                                                              				 	      node.setType(type);
                                                                          			 		       }
                                                                          			 		       RESULT = node; 
		 ...
		 System.out.println("Entrou additive exp"); 
                                                                                  ...
                                                                                  if (aea1 == null)
                                                                                      node = (Node)me1;
                                                                              	      ...
                                                                              	      String type = parser.as.maxType(((Node)me1).getType(), ((Node)aea1).getType(), me1left);
                                                                                      if (type == null)
                                                                                      	type = ((Node)aea1).getType();
                                                                              		  node.setType(type);
                                                                                  }
