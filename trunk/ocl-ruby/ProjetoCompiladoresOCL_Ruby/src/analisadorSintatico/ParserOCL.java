...
// Mon May 30 01:17:37 GMT-03:00 2011
//----------------------------------------------------
...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Mon May 30 01:17:37 GMT-03:00 2011
  */
...
class CUP$ParserOCL$actions {
 ...
 Node fCall = (Node)fCall1;
		...
		Object exp1 = (Object)((java_cup.runtime.Symbol) CUP$ParserOCL$stack.peek()).value;
		 Node node = new Node();
																 if (((String)s1).equals("Pre")){
																 	String name = "checkPre" + ((String)id) + parser.as.getContextMethod().substring(0, 1).toUpperCase() 
																	  + parser.as.getContextMethod().substring(1);
																	CodeGenerator.getInstance().addPre(parser.as.getContextMethod(), name);
																	node.setCode("\n\tdef " + name + "()\n" + ((Node)exp1).getCode() + "\n\tend\n");
																 }
																 else{
																 	String name = "checkPost" + ((String)id) + parser.as.getContextMethod().substring(0, 1).toUpperCase() 
																	  + parser.as.getContextMethod().substring(1);
